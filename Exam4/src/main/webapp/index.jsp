	...
	int curPage = 1;%>
				...
				<div style="text-align: center">
					...
					<div class="btn-group " style="float: right" id="btn-g">
						<a class="btn btn-success" href="index.jsp?curPage=1&username=<%=request.getParameter("username")%>">首页</a> <a
							class="btn btn-success" href="index.jsp?curPage=<%=curPage - 1%>&username=<%=request.getParameter("username")%>">上一页</a>
						<a class="btn btn-success"
							href="index.jsp?curPage=<%=curPage + 1%>&username=<%=request.getParameter("username")%>">下一页</a> <a
							class="btn btn-success" href="index.jsp?curPage=<%=pageCount%>&username=<%=request.getParameter("username")%>">尾页</a>
					</div>
