...
<body>
	...
	int curPage = 1;%>
											...
											<form
												...
												<div class="form-group">
													...
													<div class="row form-group">
														<div class="row">
															<div class="col-md-2" style="margin-left:20px">firstname</div>
															<input class="col-md-4" type="text" name="firstname">
														</div>
													</div>
													<div class="row form-group">
														<div class="row"">
															<div class="col-md-2" style="margin-left:20px">lastname</div>
													...
													<div class="row form-group">
														<div class="row">
															<div class="col-md-2" style="margin-left:20px">email</div>
													...
													<div class="row form-group">
														<div class="row">
															<div class="col-md-2" style="margin-left:20px">address</div>
					...
					style="margin-left: 400px;margin-top:20px" value="提交">
